...
PLUGINS_CONFIG = {
    'netbox_plugin_osism': {
        'grafana': 'http://192.168.16.254:3000',
...
DATABASE = {
    ...
    'PASSWORD': os.environ.get('DB_PASSWORD', read_secret('NETBOX_POSTGRES_PASSWORD')),
                                                         # PostgreSQL password
    'HOST': os.environ.get('DB_HOST', 'postgres'),       # Database server
...
SECRET_KEY = os.environ.get('SECRET_KEY', read_secret('NETBOX_SECRET_KEY'))
...
REDIS = {
    'tasks': {
        ...
        'DATABASE': int(os.environ.get('REDIS_DATABASE', 5)),
    ...
    'webhooks': { # legacy setting, can be removed after Netbox seizes support for it
        ...
        'DATABASE': int(os.environ.get('REDIS_DATABASE', 6)),
        'DEFAULT_TIMEOUT': int(os.environ.get('REDIS_TIMEOUT', 300)),
        'SSL': os.environ.get('REDIS_SSL', 'False').lower() == 'true',
    },
    'caching': {
        ...
        'DATABASE': int(os.environ.get('REDIS_CACHE_DATABASE', 11)),
...
EMAIL = {
    ...
    'PASSWORD': os.environ.get('EMAIL_PASSWORD', read_secret('NETBOX_EMAIL_PASSWORD')),
...
NAPALM_PASSWORD = os.environ.get('NAPALM_PASSWORD', read_secret('NETBOX_NAPALM_PASSWORD'))
